AOS.init({
 ...
 // Map
  ...
  if (document.getElementById("profitable")){
    const nextBtn = document.getElementById("scrollBtnNext");
    const prevBtn = document.getElementById("scrollBtnPrev");
    let scrollWidth = 165
    // function updateSize() {
    //     window.innerWidth >= 640 ? scrollWidth = 600 : scrollWidth = 319
    // }

    nextBtn.onclick = () => {
        document.getElementById("profitable").scrollLeft += scrollWidth;
